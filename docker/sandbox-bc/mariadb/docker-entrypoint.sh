...
# Replace environment variables in SQL files with their values. Use `|` as
# sed's delimiter so a password containing `/` doesn't poison the
# substitute expression and crash init mid-script.
