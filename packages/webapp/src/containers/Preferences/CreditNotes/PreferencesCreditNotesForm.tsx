...
export interface PreferencesCreditNotesFormProps {
...
export function PreferencesCreditNotesForm({
  isSubmitting,
}: PreferencesCreditNotesFormProps) {
  ...
  return (
    <Form>
      ...
      <FFormGroup
        name={'customerNotes'}
        label={intl.get('pref.creditNotes.customerNotes.field')}
        fastField={true}
      >
        <FTextArea
          medium={true}
      ...
      <FFormGroup
        ...
        label={intl.get('pref.creditNotes.termsConditions.field')}
        fastField={true}
      >
        <FTextArea
          medium={true}
