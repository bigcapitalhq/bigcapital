 ...
 */
export interface BillPaymentDetail extends Omit<BillPayment, 'entries' | 'vendor' | 'paymentAccount'> {
  vendor: BillPayment['vendor'] & { displayName?: string };
  paymentAccount: BillPayment['paymentAccount'] & { name?: string };
  branch?: { name?: string };
