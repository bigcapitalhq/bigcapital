export const ERRORS = {
  ...
  BANK_CODE_INVALID: 'BANK_CODE_INVALID',
  AGENCY_NUMBER_REQUIRED: 'AGENCY_NUMBER_REQUIRED',
  AGENCY_NUMBER_INVALID: 'AGENCY_NUMBER_INVALID',
  ACCOUNT_NUMBER_REQUIRED: 'ACCOUNT_NUMBER_REQUIRED',
  ACCOUNT_NUMBER_INVALID: 'ACCOUNT_NUMBER_INVALID',
  CBU_REQUIRED: 'CBU_REQUIRED',
  CBU_INVALID: 'CBU_INVALID',
};
