...
export class VendorResponseDto {
  ...
  @ApiProperty({ required: false, example: 'vendor@acme.com' })
  email?: string;
  ...
  @ApiProperty({ example: 'Preferred supplier' })
  note: string;

  @ApiProperty({ example: true })
  active: boolean;

  @ApiProperty({ required: false, example: 'V-0001' })
  code?: string;
  ...
  @ApiProperty({ required: false, example: '$1,500.00' })
  formattedBalance?: string;

  @ApiProperty({ required: false, example: '$1,000.00' })
