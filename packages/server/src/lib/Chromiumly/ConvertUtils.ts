...
export class ConverterUtils {
  public static injectPageProperties(data: FormData, pageProperties: PageProperties): void {
    ...
    if (pageProperties.nativePageRanges) {
      GotenbergUtils.assert(
        pageProperties.nativePageRanges.from > 0 &&
          ...
          pageProperties.nativePageRanges.to >= pageProperties.nativePageRanges.from,
